...
func autoConvert_v1alpha3_RuntimeSpec_To_unversioned_RuntimeSpec(in *RuntimeSpec, out *unversioned.Runtime, s conversion.Scope) error {
	*out = unversioned.Runtime(in.Name)
	return nil
}

func Convert_v1alpha3_RuntimeSpec_To_unversioned_RuntimeSpec(in *RuntimeSpec, out *unversioned.Runtime, s conversion.Scope) error {
...
// TODO: change this to use unversioned.RuntimeSpec when unversioned is updated
func autoConvert_unversioned_RuntimeSpec_To_v1alpha3_RuntimeSpec(in *unversioned.Runtime, out *RuntimeSpec, s conversion.Scope) error {
	out.Name = Runtime(string(*in))
	out.Address = RuntimeAddress("")
	return nil
}

func Convert_unversioned_RuntimeSpec_To_v1alpha3_RuntimeSpec(in *unversioned.Runtime, out *RuntimeSpec, s conversion.Scope) error {
