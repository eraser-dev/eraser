...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ScannerConfig)(nil), (*unversioned.ScannerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_ScannerConfig_To_unversioned_ScannerConfig(a.(*ScannerConfig), b.(*unversioned.ScannerConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*unversioned.ScannerConfig)(nil), (*ScannerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_unversioned_ScannerConfig_To_v1alpha3_ScannerConfig(a.(*unversioned.ScannerConfig), b.(*ScannerConfig), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*WindowsScannerConfig)(nil), (*unversioned.WindowsScannerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_WindowsScannerConfig_To_unversioned_WindowsScannerConfig(a.(*WindowsScannerConfig), b.(*unversioned.WindowsScannerConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*unversioned.WindowsScannerConfig)(nil), (*WindowsScannerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_unversioned_WindowsScannerConfig_To_v1alpha3_WindowsScannerConfig(a.(*unversioned.WindowsScannerConfig), b.(*WindowsScannerConfig), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha3_Components_To_unversioned_Components(in *Components, out *unversioned.Components, s conversion.Scope) error {
	...
	if err := Convert_v1alpha3_ScannerConfig_To_unversioned_ScannerConfig(&in.Scanner, &out.Scanner, s); err != nil {
		return err
	}
...
func autoConvert_unversioned_Components_To_v1alpha3_Components(in *unversioned.Components, out *Components, s conversion.Scope) error {
	...
	if err := Convert_unversioned_ScannerConfig_To_v1alpha3_ScannerConfig(&in.Scanner, &out.Scanner, s); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_ScannerConfig_To_unversioned_ScannerConfig(in *ScannerConfig, out *unversioned.ScannerConfig, s conversion.Scope) error {
	if err := Convert_v1alpha3_OptionalContainerConfig_To_unversioned_OptionalContainerConfig(&in.OptionalContainerConfig, &out.OptionalContainerConfig, s); err != nil {
		return err
	}
	out.Windows = (*unversioned.WindowsScannerConfig)(unsafe.Pointer(in.Windows))
	return nil
}

// Convert_v1alpha3_ScannerConfig_To_unversioned_ScannerConfig is an autogenerated conversion function.
func Convert_v1alpha3_ScannerConfig_To_unversioned_ScannerConfig(in *ScannerConfig, out *unversioned.ScannerConfig, s conversion.Scope) error {
	return autoConvert_v1alpha3_ScannerConfig_To_unversioned_ScannerConfig(in, out, s)
}

func autoConvert_unversioned_ScannerConfig_To_v1alpha3_ScannerConfig(in *unversioned.ScannerConfig, out *ScannerConfig, s conversion.Scope) error {
	if err := Convert_unversioned_OptionalContainerConfig_To_v1alpha3_OptionalContainerConfig(&in.OptionalContainerConfig, &out.OptionalContainerConfig, s); err != nil {
		return err
	}
	out.Windows = (*WindowsScannerConfig)(unsafe.Pointer(in.Windows))
	return nil
}

// Convert_unversioned_ScannerConfig_To_v1alpha3_ScannerConfig is an autogenerated conversion function.
func Convert_unversioned_ScannerConfig_To_v1alpha3_ScannerConfig(in *unversioned.ScannerConfig, out *ScannerConfig, s conversion.Scope) error {
	return autoConvert_unversioned_ScannerConfig_To_v1alpha3_ScannerConfig(in, out, s)
}
...
func autoConvert_v1alpha3_WindowsScannerConfig_To_unversioned_WindowsScannerConfig(in *WindowsScannerConfig, out *unversioned.WindowsScannerConfig, s conversion.Scope) error {
	if err := Convert_v1alpha3_RepoTag_To_unversioned_RepoTag(&in.Image, &out.Image, s); err != nil {
		return err
	}
	if err := Convert_v1alpha3_ResourceRequirements_To_unversioned_ResourceRequirements(&in.Request, &out.Request, s); err != nil {
...
// Convert_v1alpha3_WindowsScannerConfig_To_unversioned_WindowsScannerConfig is an autogenerated conversion function.
func Convert_v1alpha3_WindowsScannerConfig_To_unversioned_WindowsScannerConfig(in *WindowsScannerConfig, out *unversioned.WindowsScannerConfig, s conversion.Scope) error {
	return autoConvert_v1alpha3_WindowsScannerConfig_To_unversioned_WindowsScannerConfig(in, out, s)
}

func autoConvert_unversioned_WindowsScannerConfig_To_v1alpha3_WindowsScannerConfig(in *unversioned.WindowsScannerConfig, out *WindowsScannerConfig, s conversion.Scope) error {
	if err := Convert_unversioned_RepoTag_To_v1alpha3_RepoTag(&in.Image, &out.Image, s); err != nil {
		return err
	}
	if err := Convert_unversioned_ResourceRequirements_To_v1alpha3_ResourceRequirements(&in.Request, &out.Request, s); err != nil {
...
// Convert_unversioned_WindowsScannerConfig_To_v1alpha3_WindowsScannerConfig is an autogenerated conversion function.
func Convert_unversioned_WindowsScannerConfig_To_v1alpha3_WindowsScannerConfig(in *unversioned.WindowsScannerConfig, out *WindowsScannerConfig, s conversion.Scope) error {
	return autoConvert_unversioned_WindowsScannerConfig_To_v1alpha3_WindowsScannerConfig(in, out, s)
}
