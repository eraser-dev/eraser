...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*unversioned.Runtime)(nil), (*RuntimeSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_unversioned_Runtime_To_v1alpha3_RuntimeSpec(a.(*unversioned.Runtime), b.(*RuntimeSpec), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*RuntimeSpec)(nil), (*unversioned.Runtime)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_RuntimeSpec_To_unversioned_Runtime(a.(*RuntimeSpec), b.(*unversioned.Runtime), scope)
	}); err != nil {
		return err
	}
	return nil
