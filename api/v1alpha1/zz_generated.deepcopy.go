...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageStatusSpec) DeepCopyInto(out *ImageStatusSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageStatusSpec.
func (in *ImageStatusSpec) DeepCopy() *ImageStatusSpec {
	if in == nil {
		return nil
	}
	out := new(ImageStatusSpec)
	in.DeepCopyInto(out)
	return out
}
