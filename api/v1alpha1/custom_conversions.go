...
//nolint:revive
func Convert_v1alpha1_OptionalContainerConfig_To_unversioned_ScannerConfig(in *OptionalContainerConfig, out *unversioned.ScannerConfig, s conversion.Scope) error {
	return Convert_v1alpha1_OptionalContainerConfig_To_unversioned_OptionalContainerConfig(in, &out.OptionalContainerConfig, s)
}

// The per-OS scanner override has no v1alpha1 equivalent, so it is dropped here.
//
//nolint:revive
func Convert_unversioned_ScannerConfig_To_v1alpha1_OptionalContainerConfig(in *unversioned.ScannerConfig, out *OptionalContainerConfig, s conversion.Scope) error {
	return Convert_unversioned_OptionalContainerConfig_To_v1alpha1_OptionalContainerConfig(&in.OptionalContainerConfig, out, s)
}
