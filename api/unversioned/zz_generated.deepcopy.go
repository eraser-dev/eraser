...
func (in *ScannerConfig) DeepCopyInto(out *ScannerConfig) {
	*out = *in
	in.OptionalContainerConfig.DeepCopyInto(&out.OptionalContainerConfig)
	if in.Windows != nil {
		in, out := &in.Windows, &out.Windows
		*out = new(WindowsScannerConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WindowsScannerConfig) DeepCopyInto(out *WindowsScannerConfig) {
	*out = *in
	out.Image = in.Image
	in.Request.DeepCopyInto(&out.Request)
	in.Limit.DeepCopyInto(&out.Limit)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WindowsScannerConfig.
func (in *WindowsScannerConfig) DeepCopy() *WindowsScannerConfig {
	if in == nil {
		return nil
	}
	out := new(WindowsScannerConfig)
